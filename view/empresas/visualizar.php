                ...
                <div class="card-body">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4 text-end">
                            <a href="../../controllers/EmpresaController.php?action=editar&id=<?= $empresa['id'] ?>" class="btn btn-warning me-2">
                                <i class="bi bi-pencil"></i> Editar
                            </a>
                            <form method="POST" action="../../controllers/EmpresaController.php?action=excluir&id=<?= $empresa['id'] ?>" class="d-inline">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <strong>CNPJ:</strong> <?= htmlspecialchars($empresa['cnpj']) ?>
                                </li>
                                <li class="list-group-item">
                                    <strong>Responsável:</strong> <?= htmlspecialchars($empresa['responsavel']) ?>
                                </li>
                                <li class="list-group-item">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <strong>Telefone:</strong> <?= htmlspecialchars($empresa['telefone']) ?>
                                </li>
                                <li class="list-group-item">
